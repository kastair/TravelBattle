  ...
  //NEWS=============================================================================================
    ...
    $.ajax({
      ...
      .done(function(response) {
        ...
        $('#about1').html('<h3>' + location1 + '</h3>' + '<br><p> Summary: ' + response.geonames[0].summary + '<br><br> Wikipedia: ' + response.geonames[0].wikipediaUrl + '</p>');
      ...
      .done(function(response) {
        ...
        $('#about2').html('<h3>' + location2 + '</h3>' + '<br><p> Summary: ' + response.geonames[0].summary + '<br><br> Wikipedia: ' + response.geonames[0].wikipediaUrl + '</p>');
